...
public class TelaDeLogin extends JFrame {
        ...
        public void actionPerformed(ActionEvent event) {
            try{
                ...
                if (rstSqlLogin.next()){
                    ...
                    lblNotificacoes.setText("Não foi possivel encontrar o login e/ou senha digitados. Por favor, verifique e tenta novamente.");
                 // aqui vamos notificar o usuario que o login e senha nao foram encontrados
                }
            }
            catch (Exception e) {
                lblNotificacoes.setText("Houve um problema e não sera possivel realizar o ligin neste momento. Poir favor, tente novamente mais tarde.");
    ...
    public static void main(String[] args){
        ...
        appTelaDeLogin.setSize(220, 260);
